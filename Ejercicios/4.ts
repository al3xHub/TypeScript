...
let cuadrado: main.FormaGeometrica = new main.Cuadrado("rojo", 5, "equilatero", 10);
let circulo: main.FormaGeometrica = new main.Circulo("azul", 2,"ovalado", 10, 5);
let triangulo: main.FormaGeometrica = new main.Triangulo("verde", 1,"equilatero", 5, 10);
